local warriorBox = Action()

local items = {
    {id = 14758, count = 1, name = "VIP 30 days"},
    {id = 9177, count = 8, name = "Addon Doll"},
    {id = 49284, count = 4, name = "Rare Addon Doll"},
    {id = 49285, count = 2, name = "Supreme Addon Doll"},
    {id = 49283, count = 2, name = "Mystic Dice"},
}

local offerId = 23721


function warriorBox.onUse(player, item, fromPosition, target, toPosition, isHotkey)
