...
GameStore.Categories = {
	 ...
	 -- Set Itens
	{
		...
		name = "Set Itens",
		rookgaard = true,
		subclasses = {"Sanguine", "Primal", "Soul", "Falcon", "Lion", "Naga", "Gnome", "Cobra", "Destruction"},
	},
	-- Sanguine
	{
		icons = { "Category_ExclusiveOffers.png" },
				...
				offers = {
					{
						...
						itemtype = 5942,
						count = 1,
						description = "Many mighty priests of Tibia have blessed this stake",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
						movable = true,
						setOwner = false
					},
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			{
				icons = { "OneDay_Exercise_Axe.png" },
				name = "OneDay Exercise Axe",
				price = 100,
				itemtype = 35286,
				charges = 43200,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 43200 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = { "OneDay_Exercise_Bow.png" },
				name = "OneDay Exercise Bow",
				price = 100,
				itemtype = 35288,
				charges = 43200,
				description = "<i>Use it to train your distance fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your distance fighting skill\n{info} usable 43200 times a piece",
			...
			{
				icons = { "OneDay_Exercise_Club.png" },
				name = "OneDay Exercise Club",
				price = 100,
				itemtype = 35287,
				charges = 43200,
				description = "<i>Use it to train your club fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your club fighting skill\n{info} usable 43200 times a piece",
			...
			{
				icons = { "OneDay_Exercise_Rod.png" },
				name = "OneDay Exercise Rod",
				price = 100,
				itemtype = 35289,
				charges = 43200,
				description = "<i>Use it to train your magic level on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your magic level\n{info} usable 43200 times a piece",
			...
			{
				icons = { "OneDay_Exercise_Sword.png" },
				name = "OneDay Exercise Sword",
				price = 100,
				itemtype = 35285,
				charges = 43200,
				description = "<i>Use it to train your sword fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your sword fighting skill\n{info} usable 43200 times a piece",
			...
			{
				icons = { "OneDay_Exercise_Wand.png" },
				name = "OneDay Exercise Wand",
				price = 100,
				itemtype = 35290,
				charges = 43200,
				description = "<i>Use it to train your magic level on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your magic level\n{info} usable 43200 times a piece",
			...
			{
				icons = { "OneDay_Exercise_Shield.png" },
				name = "OneDay Exercise Shield",
				price = 100,
				itemtype = 44067,
				charges = 43200,
				description = "<i>Use it to train your shielding skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your shielding skill\n{info} usable 43200 times a piece",
		...
		offers = {
			{
				...
				itemtype = 9177,
				count = 1,
				description = "{character}\n{info} How about a different look?\n{info} This item randomly adds addons to one of the game's base outfits.\n\n<i>Except Ferumbras' Hat</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Rare_Addon_Doll.png" },
				name = "Rare Addon Doll",
				price = 25,
				itemtype = 49284,
				count = 1,
				description = "{character}\n{info} How about a different look?\n{info} This item randomly adds a full quest outfit from the game.\n\n<i>Except Ferumbras' Hat</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Supreme_Addon_Doll.png" },
				name = "Supreme Addon Doll",
				price = 100,
				itemtype = 49285,
				count = 1,
				description = "{character}\n{info} How about a different look?\n{info} This item randomly adds a full outfit from the store.\n\n<i>Except Ferumbras' Hat</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				itemtype = 49288,
				count = 1,
				description = "{character}\n{info} How about a new mount?\n{info} This item randomly adds a quest mount.\n\n<i>Except Rift Ridder, Sparkion, Neon Sparkid, Vortexion, and Fleeting Knowledge</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				icons = { "Supreme_Mount_Doll.png" },
				name = "Supreme Mount Doll",
				price = 75,
				itemtype = 49292,
				count = 1,
				description = "{character}\n{info} How about a new mount?\n{info} This item randomly adds a mount from the store.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
		},
	},
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 23721,
				count = 1,
				description = "<i>Carries as many gold, platinum or crystal coins as your capacity allows and other items. remember to use ~ !autoloot on. ~</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use it to open it\n{info} always placed on the first position of your Store inbox",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Loot_Seller.png" },
				name = "Loot Seller",
				price = 450,
				itemtype = 49286,
				count = 1,
				description = "<i>Sell your loot easily, directly from your loot pouch to the bank, wherever you are. ~</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use it to open it\n{info} always placed on the first position of your Store inbox.\n{info} When the item is used, all items in the Loot Pouch will be sold, and a <b>10% tax</b> will be charged to the kingdom.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Explorer_Call.png" },
				name = "Explorer Call",
				price = 450,
				itemtype = 49287,
				count = 1,
				description = "<i>Need potions? How about calling the explorer to help you? He has everything you need to continue your journey.</i>\n\n{character}\n{storeinbox}\n{once}\n{useicon} use it to open it\n{info} always placed on the first position of your Store inbox.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
	...
	{
		icons = { "Category_Packages.png" },
		name = "Pacotes",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
				icons = { "Citizen_Box.png" },
				name = "Pacote Citizen",
				price = 450,
				itemtype = 49279,
				count = 1,
				description = "Pacote Citizen:\n- 30 dias de VIP;\n- Loot Pouch;\n- 4 Addon Doll;\n- 2 Rare Addon Doll;\n- 1 Supreme Addon Doll;\n- 1 Mystic Dice;\n Apoie o Servidor!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Warrior_Box.png" },
				name = "Pacote Warrior",
				price = 900,
				itemtype = 49280,
				count = 1,
				description = "Pacote Warrior:\n- 30 dias de VIP;\n- Loot Pouch;\n- 8 Addon Doll;\n- 4 Rare Addon Doll;\n- 2 Supreme Addon Doll;\n- 2 Mystic Dice;\n Apoie o Servidor!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Nobleman_Box.png" },
				name = "Pacote Nobleman",
				price = 1350,
				itemtype = 49281,
				count = 1,
				description = "Pacote Nobleman:\n- 30 dias de VIP;\n- Loot Pouch;\n- 12 Addon Doll;\n- 6 Rare Addon Doll;\n- 3 Supreme Addon Doll;\n- 3 Mystic Dice;\n Apoie o Servidor!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Mistic_Ball.png" },
				name = "Mystic Dice",
				price = 125,
				itemtype = 49283,
				count = 1,
				description = "Role seu D20 e Apoie o Servidor!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			}
		},
	},
